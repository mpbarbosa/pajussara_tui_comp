 ...
 */
function renderToLines(diagram) {
    try {
 ...
 */
export function MermaidPanel({ diagram, width, height = 20, title = 'DIAGRAM', isFocused = false, }) {
    ...
    }, React.createElement(Box, { paddingX: 1 }, React.createElement(Text, { bold: true, color: isFocused ? 'cyan' : 'white', wrap: 'truncate' }, title)), ...visibleLines.map((line, i) => React.createElement(Box, { key: i, paddingX: 1 }, React.createElement(Text, { color: error ? 'red' : undefined, wrap: 'truncate' }, line || ' '))), React.createElement(Box, { paddingX: 1 }, React.createElement(Text, { color: error ? 'red' : 'gray', wrap: 'truncate' }, footerText)));
}
export default MermaidPanel;
//# sourceMappingURL=MermaidPanel.js.map