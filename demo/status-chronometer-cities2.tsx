/**
 * @fileoverview Demo — ListPanel with a world-cities tour and StatusChronometer integration (no border)
 * @module demo/status-chronometer-cities2
 *
 * Variant of the status-chronometer-cities demo with the Chronometer border
 * disabled (`showBorder: false`). All other behaviour is identical: the tour
 * automatically visits each city every 1.8 s, the badge shows a spinner while
 * running and a green ✓ Done when all cities have been visited, and the
 * chronometer tracks total elapsed time.
